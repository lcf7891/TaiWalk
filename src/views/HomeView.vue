...
<template>
  ...
  <article class="mb-9">
    <div class="flex justify-between items-center md:mb-3 mb-2">
      ...
      <router-link class="btn-hover text-tertiary font-medium mr-2" to="/">查看更多活動</router-link>
    </div>
    <!-- 橫式卡 -->
  ...
  <article class="mb-9">
    <div class="flex justify-between items-center md:mb-3 mb-2">
      ...
      <router-link class="btn-hover text-tertiary font-medium mr-2" to="/">查看更多景點</router-link>
    </div>
    <!-- 直式卡 -->
  ...
  <article class="mb-9">
    <div class="flex justify-between items-center md:mb-3 mb-2">
      ...
      <router-link class="btn-hover text-tertiary font-medium mr-2" to="/">查看更多美食</router-link>
    </div>
    <!-- 直式卡 -->
    <section class="grid lg:grid-cols-4 grid-cols-2 md:gap-x-7 gap-x-4 agp-y-4">
      <CardVer v-for="num in 4" :key="num+2"></CardVer>
